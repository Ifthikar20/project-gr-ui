...
import { SectionCard } from '@/components/Bits'
...
export function JoinCta() {
  ...
  return (
    <SectionCard id="join" className="relative overflow-hidden py-16 text-center md:py-24">
      ...
      <div
        ...
        style={ctaGlow}
      />
      <Reveal className="relative z-10 mx-auto max-w-[620px]">
