          ...
          <div className="relative z-10 mx-auto max-w-[880px]">
            ...
            <ul className="mt-6 flex flex-wrap justify-center gap-2.5">
              {residency.map((item) => (
                <li
                  key={item.label}
                  className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[13px] font-medium text-white/75 backdrop-blur-sm transition-[background-color,transform,border-color] duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10"
                >
