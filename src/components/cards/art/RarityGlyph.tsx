...
export function RarityGlyph({ tier, className }: { tier: RarityTier; className?: string }) {
  const cls = cn('size-[21px]', className)
  switch (tier) {
    case 'common':
      return (
    ...
    case 'epic':
      return (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" className={cls}>
