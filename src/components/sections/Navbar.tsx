  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="flex items-center justify-between px-5 py-4 md:px-8 md:py-5">
        <a href="#top" aria-label="RunnerCard home" className="flex items-baseline gap-1.5">
          <span className="text-[16px] font-semibold text-black">RunnerCard</span>
          <span className="text-[10px] font-medium tracking-[0.08em] uppercase text-black/40">beta</span>
        </a>
